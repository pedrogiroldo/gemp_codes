...
hidden if the `ex8_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `ex8_DEVELOPER_MODE` to the configure
...
Runs the executable target `ex8_exe`.
